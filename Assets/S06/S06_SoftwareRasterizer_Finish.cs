...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(100, 150);
    [SerializeField] private Vector2 vertexB = new Vector2(40, 10);
    [SerializeField] private Vector2 vertexC = new Vector2(170, 80);
    [SerializeField] private Color fillColor = new Color(0.7f, 0.4f, 0f, 0.8f);
